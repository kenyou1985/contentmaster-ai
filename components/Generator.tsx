...
11. **「咱们下期见」自然出现**：在论证完整、结论已给出之后，作为最后一个句子出现，前面紧跟结论句。不要先写互动引导段再接「咱们下期见」，不要在中间突然跳到互动引导破坏论证流畅度。
12. **收尾句数限制**：从「咱们下期见」往前数，前面最多有 2 句议论/结论/互动引导。不允许在正文末段塞入 4-5 句后再写「咱们下期见」。
13. **结尾禁止出现**："各位看官"、"对此你又有什么看法？欢迎在评论区留言"——只保留「咱们下期见」。

**五、字数节奏**
14. **总字数必须落在 ${plan.minChars} - ${plan.maxChars} 字之间**。
15. **正文未满 ${plan.minChars} 字之前：严格禁止出现任何收尾语**、「咱们下期见」等。
