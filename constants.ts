...
👉 **输入 \`模式一\`**：生成爆款心理学选题与 3000-5000 字纯净 TTS 语音配音脚本。
👉 **输入 \`模式二 + 您的脚本/文本\`**：启动高级动画分镜引擎，将文本转化为【极简2D扁平化插画风】的工业级动画分镜表，人类与治愈小狗将同框演绎。"
...
- **英文部分**：YouTube 点击向标题，须含对应主题关键词（猫主题含 cat/kitten/meow 等，狗主题含 dog/puppy/paw 等，人类主题可不含宠物词但需有心理学/情感关键词）
