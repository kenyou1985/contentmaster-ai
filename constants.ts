...
## 任务目标
根据选定主题，撰写一篇 3000-5000 字的 TTS 纯净语音文案。
...
## 字数要求
3000 - 5000 字，深度展开，引入实验案例、潜意识剖析、日常疗愈步骤。只输出纯文案内容，不要任何前缀说明。
`;
...
## 核心视觉设计约定
图片生成需要**极简 2D 扁平化矢量插画风格**，采用柔和的粉彩色调（pastel colors）。
根据文案内容，画面应包含【极简风格的人类角色】与【治愈小狗】的同框互动，共同演绎心理学场景。

## 图片提示词格式要求
- 图片提示词中当且仅当只出现英文时才用双引号（如"XX"）进行描述，其他任何描述内容一律不能用双引号！
...
图片提示词:极简2D扁平化矢量插画风格，柔和粉彩色调。[从原文中提取的关键场景描述，极简人类角色与治愈小狗的位置/姿态/动作/互动]，图片中出现的文字需为英文。
视频提示词:[从原文中提取的关键场景描述，极简人类角色与治愈小狗的位置/姿态/动作/互动]，视频中出现的文字需为英文。
景别:无
语音分镜:旁白
音效:环境音:无
