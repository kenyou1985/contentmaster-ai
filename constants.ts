...
视：视频提示词（Wan2.2 图生视频提示词，**必须基于上方「图」首帧画面 + 「镜头文案」剧情**编写，让 Wan2.2 围绕该图人物生成与剧情相匹配的人物动作短视频片段。严格按下方"四段式中文模板"连续输出，不要换行断开：
  [通用人物动作正向基础]，[剧情/人物细分动作]，[运镜与防崩坏优化]，[音效与光影氛围]；
  [负面避坑词]（与正向词用「||」或换行分开独立成行）。
  通用人物动作正向基础：全身镜头，单人角色，流畅自然人体动作，连贯不间断动态，全程五官身形统一不变，四肢比例稳定无肢体扭曲，符合人体骨骼运动规律，肌肉拉伸真实，头部转动自然手臂摆动真实步伐舒展，身体轻微自然晃动呼吸细微动态，面部表情与动作匹配，衣物随动作自然形变头发动态飘动真实布料褶皱跟随身体变化，24帧，柔和运动模糊，电影级柔光浅景深，超高细节，8K画质照片级写实。
  剧情/人物细分动作（**核心**：从走/跑/跳、姿态变换、头颈/面部、手势/手部、情绪微动作、爱情/情感推进这 6 类动作词库中精准选 1-3 个最贴合本镜剧情的具体动作，紧扣「镜头文案」原文，例如原文是"她缓缓转身"则必须选"缓缓转身/优雅转身"，禁止"看着她的眼睛/调整姿势"等空洞泛泛描述）。
  运镜与防崩坏优化：缓慢跟拍镜头，镜头跟随人物平稳移动，构图稳定，人物始终位于画面中心，画面时序连贯统一，全程不换脸身形不会忽大忽小，平滑帧间过渡，四肢添加自然动态模糊，身体移动伴随细微景深变化，阴影跟随人体柔和移动。
  音效与光影氛围：柔和电影级柔光，光影随人物动作自然流转，色彩与图片提示词保持一致，背景虚化柔和，整体氛围贴合镜头文案情绪。
  负面避坑词（独立成行）：最差画质，低清模糊，肢体扭曲变形，手指残缺，多出手臂，缺失腿部，躯干扭曲，五官变形，每帧人脸变化，人物身形忽大忽小，轮廓闪烁，衣物破损，头发无重力漂浮，机器人僵硬卡顿动作，身体抖动跳帧，画面重影，人物重复重叠，动作断裂不连贯，四肢僵硬无法弯曲，六指，缺指，肢体悬浮。
  长度铁律：正向 80-180 字，不超过 220 字；全简体中文，逗号/分号/句号分隔，不要换行；严禁"镜头提示词/视频提示词"等元标签；严禁英文 prompt。）
...
**【视频提示词·核心铁律】** 视频提示词是 Wan2.2 图生视频模型的核心指令，**必须**与同一镜头的「图片提示词」所描述的首帧画面和「镜头文案」所对应的剧情节点**一一对应**——即：先有图片，再用一段中文人物动作描述告诉 Wan2.2"该图中的人物接下来 2-5 秒要做什么动作、做什么表情、走什么运镜"，目的是让 Wan2.2 围绕该图片中的人物**生成与剧情相对应匹配的人物动作短视频片段**。**严禁**生成与图片/剧情无关的空洞泛泛描述（如"看着她的眼睛/调整她的姿势/整体氛围"），**严禁**只写运镜而不写人物动作，**严禁**英文 prompt。详细四段式模板见下方"输出格式"中的「视频提示词」字段。
...
| 睡前历史人物 | 讲述者+小狗 | 温暖人类与历史人物故事同框（保持现有风格不变） | 极简2D扁平插画 | 每3-5镜1次 |
...
视频提示词:[Wan2.2 图生视频提示词，**必须基于上方「图片提示词」已生成的首帧画面** + 「镜头文案」对应的剧情进行编写，目的是让 Wan2.2 围绕该图片中的人物生成与剧情相匹配的人物动作短视频片段。**严格按下方"四段式中文模板"连续输出，不要换行断开，不要加序号，不要加引号**：
  [通用人物动作正向基础]，[剧情/人物细分动作]，[运镜与防崩坏优化]，[音效与光影氛围]；
  [负面避坑词]（与正向词用换行或「||」分开单独成行，确保 Wan2.2 不会生成畸形/穿模/抖动画面）。

  — 通用人物动作正向基础（每次都必写，作为身体/造型稳定性兜底）：
  全身镜头，单人角色，流畅自然人体动作，连贯不间断动态，全程五官身形统一不变，四肢比例稳定无肢体扭曲，符合人体骨骼运动规律，肌肉拉伸真实，头部转动自然手臂摆动真实步伐舒展，身体轻微自然晃动呼吸细微动态，面部表情与动作匹配，衣物随动作自然形变头发动态飘动真实布料褶皱跟随身体变化，24帧，柔和运动模糊，电影级柔光浅景深，超高细节，8K画质照片级写实。

  — 剧情/人物细分动作（**这是核心，必须紧扣该镜头的「镜头文案」+「图片提示词」中正在发生的情节，从下方动作词库中精准选用 1-3 个最能体现本镜剧情的具体动作，禁止泛泛而谈**）：
  ...
  **重要约束**：所选动作必须与上方「镜头文案」描述的剧情节点一一对应（例如：镜头文案是"她缓缓转身"则必须选"缓缓转身/优雅转身"；是"他抬眼看她"则必须选"缓缓抬眸/目光凝望"；是"两人四目相对"则必须选"四目相对/含情凝望"），禁止写出与剧情无关的通用动作。

  — 运镜与防崩坏优化（每次都必写，作为画面稳定/防换脸/防穿模兜底）：
  缓慢跟拍镜头，镜头跟随人物平稳移动，构图稳定，人物始终位于画面中心，画面时序连贯统一，全程不换脸身形不会忽大忽小，平滑帧间过渡，四肢添加自然动态模糊，身体移动伴随细微景深变化，阴影跟随人体柔和移动。

  — 音效与光影氛围（每次都必写）：
  柔和电影级柔光，光影随人物动作自然流转，色彩与图片提示词保持一致，背景虚化柔和，整体氛围贴合镜头文案情绪（欢快/悲伤/暧昧/激越）。

  — 负面避坑词（每次都必加，独立成行，用「||」或换行与正向词分隔）：
  最差画质，低清模糊，肢体扭曲变形，手指残缺，多出手臂，缺失腿部，躯干扭曲，五官变形，每帧人脸变化，人物身形忽大忽小，轮廓闪烁，衣物破损，头发无重力漂浮，机器人僵硬卡顿动作，身体抖动跳帧，画面重影，人物重复重叠，动作断裂不连贯，四肢僵硬无法弯曲，六指，缺指，肢体悬浮。

  — 长度与节奏约束（铁律）：
  · 正向部分总长度 80-180 个汉字，不要超过 220 字，否则 Wan2.2 容易忽略关键动作；
  · 全部使用简体中文，逗号/分号/句号分隔，不要换行断开；
  · 严禁出现"镜头提示词"、"视频提示词"、"运镜描述"等元标签；
  · 严禁"看着她的眼睛/调整她的姿势/整体氛围"等空洞泛泛描述，必须落实到具体可执行的人物动作；
  · 严禁使用英文 prompt，Wan2.2 中文图生视频对中文动作指令遵循度更高。

  — 完整模板示例（仅供 LLM 参考，禁止照抄，必须按本镜头剧情重写）：
  全身镜头，单人角色，流畅自然人体动作，连贯不间断动态，全程五官身形统一不变，四肢比例稳定无肢体扭曲，符合人体骨骼运动规律，肌肉拉伸真实，头部转动自然手臂摆动真实步伐舒展，身体轻微自然晃动呼吸细微动态，面部表情与动作匹配，衣物随动作自然形变头发动态飘动真实布料褶皱跟随身体变化，24帧，柔和运动模糊，电影级柔光浅景深，超高细节，8K画质照片级写实。缓缓起身回眸，目光从远方收回，纤指轻抚发丝，唇角微微上扬，眼神中带着怦然心动的波澜，缓步向画面中央走来，衣袂随动作轻轻飘动。缓慢跟拍镜头，镜头跟随人物平稳移动，构图稳定，人物始终位于画面中心，画面时序连贯统一，全程不换脸身形不会忽大忽小，平滑帧间过渡，四肢添加自然动态模糊，身体移动伴随细微景深变化，阴影跟随人体柔和移动。柔和电影级柔光，光影随人物动作自然流转，暖色调虚化柔和，整体氛围怦然心动含情脉脉。
  最差画质，低清模糊，肢体扭曲变形，手指残缺，多出手臂，缺失腿部，躯干扭曲，五官变形，每帧人脸变化，人物身形忽大忽小，轮廓闪烁，衣物破损，头发无重力漂浮，机器人僵硬卡顿动作，身体抖动跳帧，画面重影，人物重复重叠，动作断裂不连贯，四肢僵硬无法弯曲，六指，缺指，肢体悬浮。]
