...
# 时间规则（绝对禁止）
- 禁止出现任何“当前时间/今天/今日/此刻/当前UTC时间/系统时间”字样。
- 禁止出现具体公历日期与具体时刻（如：2026年3月23日、3月23日、14:30、UTC）。
- 使用模糊时间表达（如：近来、这些年、那阵子、长期）。
...
# 时间规则（绝对禁止）
- 禁止出现任何当前系统时间或具体日期/时刻。
- 禁止出现“今天/今日/当前UTC时间/具体年月日/具体几点”。
